...
; next map. The Safari Zone has no wild table of its own: features/safari.asm
...
UCCutEncounters::
    ...
    db UC_CAVE, NIDORAN_M, 52 ; 20%
    db UC_CAVE, NIDORAN_F, 52 ; 20%
    db UC_CAVE, NIDORINO, 26; 10%
    db UC_CAVE, NIDORINA, 26 ; 10%
    db UC_CAVE, VENONAT, 52 ; 20%
    db UC_CAVE, PARAS, 26 ; 10%
    db UC_CAVE, PARASECT, 12 ; 5%
    db UC_CAVE, CHANSEY, 10 ; 4%
    db 0
